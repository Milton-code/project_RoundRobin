 ...
 * @author milton
 */
public class RafagaMayor extends javax.swing.JFrame {

    /**
     * Creates new form RafagaMayor
     */
    public RafagaMayor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("La ráfaga no puede ser mayor de 100");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RafagaMayor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RafagaMayor().setVisible(true);
            }
        });
    }

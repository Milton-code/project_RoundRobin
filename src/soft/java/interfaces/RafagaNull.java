...
public class RafagaNull extends javax.swing.JFrame {

    /**
     * Creates new form RafagaNull
     */
    public RafagaNull() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("El valor no puede ser, 0 (cero)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RafagaNull.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RafagaNull().setVisible(true);
            }
        });
    }

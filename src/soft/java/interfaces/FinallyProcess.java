...
public class FinallyProcess extends javax.swing.JFrame {

    public FinallyProcess() {
        initComponents();
        setTitle("Round Robín - Finalizo");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ejecución Finalizada");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinallyProcess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinallyProcess().setVisible(true);
            }
        });
    }

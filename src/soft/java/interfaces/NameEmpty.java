...
public class NameEmpty extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("El campo (quantum) debe contener un valor, númerico");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NameEmpty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
